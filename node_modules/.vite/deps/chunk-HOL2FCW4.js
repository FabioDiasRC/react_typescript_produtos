...
var Modal = (0, import_react7.forwardRef)((_ref, ref) => {
  ...
  if (Transition) {
    dialog = (0, import_jsx_runtime8.jsx)(Transition, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition2) {
      backdropElement = (0, import_jsx_runtime8.jsx)(BackdropTransition2, {
        appear: true,
        in: !!show,
  ...
  return (0, import_jsx_runtime8.jsx)(import_jsx_runtime9.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime10.jsxs)(import_jsx_runtime9.Fragment, {
...
var NavbarCollapse = React11.forwardRef(({
  ...
  return (0, import_jsx_runtime15.jsx)(Collapse_default, {
...
//# sourceMappingURL=chunk-HOL2FCW4.js.map
