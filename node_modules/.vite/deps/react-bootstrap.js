...
import {
  ...
  TabContext_default,
  useNavItem
} from "./chunk-44R7DZB2.js";
import {
  Anchor_default,
  useCallbackRef
} from "./chunk-BEIVIY5H.js";
import "./chunk-MI4XWUAY.js";
import {
  contains
} from "./chunk-36VGBDXC.js";
import {
  ...
  require_prop_types
} from "./chunk-S4VBXRQE.js";
import {
  SelectableContext_default,
  makeEventKey
} from "./chunk-YKFDTFXW.js";
import {
  require_browser,
  useEventCallback,
...
var Feedback = React17.forwardRef(
  ({
    as: Component2 = "div",
    className,
    type = "valid",
    tooltip = false,
    ...props
  }, ref) => (0, import_jsx_runtime17.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames14.default)(className, `${type}-${tooltip ? "tooltip" : "feedback"}`)
  })
);
...
var FormCheckInput = React19.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
  ...
  return (0, import_jsx_runtime18.jsx)(Component2, {
    ...
    type,
    id: id || controlId,
    className: (0, import_classnames15.default)(className, bsPrefix, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormCheckLabel = React20.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
  ...
  return (0, import_jsx_runtime19.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React21.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const input = (0, import_jsx_runtime20.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime20.jsx)(FormContext_default.Provider, {
    value: innerFormContext,
    children: (0, import_jsx_runtime20.jsx)("div", {
      style,
      className: (0, import_classnames17.default)(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === "switch" && bsSwitchPrefix),
      children: children || (0, import_jsx_runtime22.jsxs)(import_jsx_runtime21.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime20.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime20.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormControl = React22.forwardRef(({
  bsPrefix,
  type,
  size: size2,
  htmlSize,
  ...
  return (0, import_jsx_runtime23.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames18.default)(className, classes, isValid && `is-valid`, isInvalid && `is-invalid`, type === "color" && `${bsPrefix}-color`)
  });
});
...
var FormGroup = React23.forwardRef(({
  controlId,
  as: Component2 = "div",
  ...props
}, ref) => {
...
var FormLabel = React24.forwardRef(({
  ...
  const classes = (0, import_classnames19.default)(className, bsPrefix, visuallyHidden && "visually-hidden", column && columnClass);
  true ? (0, import_warning2.default)(controlId == null || !htmlFor, "`controlId` is ignored on `<FormLabel>` when `htmlFor` is specified.") : void 0;
  htmlFor = htmlFor || controlId;
  if (column)
    return (0, import_jsx_runtime25.jsx)(Col_default, {
      ref,
      as: "label",
      className: classes,
      htmlFor,
...
FormLabel.defaultProps = defaultProps7;
...
var FormRange = React25.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
  ...
  return (0, import_jsx_runtime26.jsx)("input", {
    ...props,
    type: "range",
    ref,
...
var FormSelect = React26.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
  ...
  return (0, import_jsx_runtime27.jsx)("select", {
    ...props,
    size: htmlSize,
    ref,
    className: (0, import_classnames21.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var FormText = React27.forwardRef(
  ({
    bsPrefix,
    className,
    as: Component2 = "small",
    ...
    return (0, import_jsx_runtime28.jsx)(Component2, {
      ...props,
      ref,
      className: (0, import_classnames22.default)(className, bsPrefix, muted && "text-muted")
    });
  }
);
...
var Switch = React28.forwardRef((props, ref) => (0, import_jsx_runtime29.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React29.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
  ...
  return (0, import_jsx_runtime31.jsxs)(FormGroup_default, {
    ref,
    className: (0, import_classnames23.default)(className, bsPrefix),
    controlId,
    ...props,
    children: [children, (0, import_jsx_runtime30.jsx)("label", {
      htmlFor: controlId,
      children: label
    })]
  });
...
var Form = React30.forwardRef(({
  ...
  ...props,
  ref,
  className: (0, import_classnames24.default)(className, validated && "was-validated")
}));
...
var Modal = React38.forwardRef(({
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime40.jsx)("div", {
    ...
    className: (0, import_classnames32.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`),
...
var Overlay = React39.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime41.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
var ToastFade = React61.forwardRef((props, ref) => (0, import_jsx_runtime69.jsx)(Fade_default, {
  ...props,
  ref,
